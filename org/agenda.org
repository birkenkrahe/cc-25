...
* IN-PROGRESS Week 16: Transitioning to C++
#+attr_html: :width 400px :float nil:
...
- *Optional final exam*: Monday, 12-May, 1:00 pm - 3:00 pm *here*
...
** DONE Review Questions: From struct in C to class in C++
...
** TODO Code Along Review: Constructors and Destructors 
...
6) Now create a second car, a =jaguar= from =1985= with =220,000= miles.
   ...
   #+end_quote
** TODO What (if anything) are you taking away from this course?
#+attr_html: :width 400px :float nil: 
[[../img/finale3.png]]
...
4) *Data Structures (with C++*): The next course in the series, for
...
5) *Introduction to Data Science (with R)*: DSC 105 is the first course
...
#+begin_src R :file ../img/final_grades.png :session *R* :results graphics output file :exports both
          grades <- c(72.75,77.27,77.97,85.17,88.96,88.98,90.05,95.97,96.18,97.68,
...
#+begin_src R :file ../img/final_grades.png :session *R* :results graphics output file :exports both
  midterm_grades <- c(26.92, 43.1, 45.75, 57.78, 59.77, 60.71, 69.8, 74.05, 76.22, 82.32,
                      84.16, 84.33, 84.55, 85.27, 86.05, 86.87, 88.36, 90.25, 90.44, 90.65,
                      91.3, 91.8, 92.25, 92.78, 93.73, 94.42, 96.46, 97.33, 97.88)
  plot(density(midterm_grades), col="red", lwd=2, main="Density Plot of Midterm Grades")
  ...
  final_grades <- c(72.75,77.27,77.97,85.17,88.96,88.98,90.05,95.97,96.18,97.68,
                    98.12,99.31,101.39,101.74,101.74,102.02,103.09,104.09,104.13,
                    106.28,106.33,106.36,104.4,108.12,108.63,110.16,119.41,124.63)
  plot(density(final_grades), col="blue", lwd=2, main="Density Plot of Final Final_Grades")
  abline(v=mean(final_grades), col="blue", lwd=2, lty=2)
  legend("topleft", legend=c(paste("Mean =", round(mean(midterm_grades), 2)),
                             paste("Mean =", round(mean(final_grades), 2))),
         col=c("red", "blue"),
         lty=c(1, 2),
         lwd=2)
#+end_src
