...
** TODO New test - Command-line and Operators
...
** TODO Three simple programming assignments
...
- We'll finish the lecture today and do the exercises on Wednesday.
- If we don't finish all practice exercises, do them on your own.
- The practice files (& their submission) will not be graded.
- You'll get sample solutions next week.
