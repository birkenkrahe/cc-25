...
Tips:
- [ ] *Calculus*: If it math scares you, learn it with Python!

This week:
- [ ] *New test:* Arrays!
- [ ] *New programming assignment:* [[https://lyon.instructure.com/courses/3113/assignments/43868][Fibonacci series with arrays]].
- [ ] *New bonus problem:* [[https://lyon.instructure.com/courses/3113/assignments/43867][Euler number approximation with loops]].
- [ ] *More on multidimensional *arrays* and ~sizeof~: read the script!
- [ ] *Lecture/practice:* C functions.

Next week:
- [ ] *Home programming assignment:* Encapsulate formula in function.
- [ ] *Bonus assignment*: Design function for weighted averages.
