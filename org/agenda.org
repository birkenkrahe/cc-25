...
- [ ] *Wednesday 19 March*: Last day to drop class with *W* (Withdrawal).
...
- [ ] *Home assignment*: Telephone area codes with ~switch~ (April 4).
- [ ] *Popquiz:* Test your knowledge of pseudocode and ~IF~ structures!
