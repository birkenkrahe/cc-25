...
** DONE Review of the last lecture - Integer types
...
** DONE Review of the in-class programming practice
#+attr_html: :width 400px:
...
** DONE Where can I get more practice problems?
...
** DONE Review of the last lecture - Floating point types
...
** TODO Review of the last lecture
...
** TODO New programming assignment "Your height in light-years"
...
- To avoid having to print 3.49049200000000, the =printf= statement uses
  scientific or E-notation with the =%e= format specifier.
