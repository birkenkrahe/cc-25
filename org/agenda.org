...
- [ ] The lectures 1-18 are now available as PDFs in GitHub.

** DONE Invitation - Join me on Friday 4pm in Nucor
#+attr_html: :width 600px:
[[../img/talk.png]]

** DONE Review 1: Pointers (creation to initialization)
...
** TODO Review: Pointers (pass by value or reference)
