...
* Week 8: Operators II & Conditionals: ~if~ & ~else~
#+attr_html: :width 400px :float nil: 
...
** DONE New test - Command-line and Operators
...
** DONE Three simple programming assignments
...
** IN-PROGRESS Operators Practice (Lab)
