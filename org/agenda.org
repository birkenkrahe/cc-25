...
** IN-PROGRESS Continued: Pseudocode/if-else
...
** TODO Review: Programming assignments

#+begin_src R :file midterm.png :session *R* :results graphics output file :exports both
   grades <- c(25.66,35.89,38.64,51.99,52.11,53.79,57.87,59.03,63.96,
               70.81,73.62,74.4,75.24,76.6,79.96,80.21,83.71,83.79,83.94,
               88.6,88.83,89.26,90.23,91.43,91.54,93.07,94.49,95.34,95.48)
   plot(density(grades),col="red",lwd=2)
   #+end_src
...
- Many submissions for the "De Morgan's Law Demonstrator" looked
  correct but did not exactly reproduce the test output. You can
  resubmit for 50% of the points.
...
- For this exercise, if you did not get the right output, you can
  resubmit for 50% of the points.

- If you think that I made a mistake, you can still let me know after
  this class (by 11 pm).

- None of the people with low grades have attempted any of the bonus
  exercises yet. I will put out a few more for you to practice!

* TODO Review: Pseudocode
...
9. *Translate this pseudocode to source code:*
   ...
   #+end_src
   #+begin_src C :results output
     int items = 7; // test: change to 12 items
   ...
   #+RESULTS:
   : Treasure collected. Inventory = 8
