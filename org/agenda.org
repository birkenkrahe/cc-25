...
* Week 11: ~do-while~ and ~for~ loops
#+attr_html: :width 400px :float nil:
...
- [ ] *Assignment* with ~switch~ - Georgia Telephone Codes
- [ ] *Assignment* with ~while~ - Sum of integers
- [ ] *Test 8* on ~while~ loops

*Work this week:*
- [ ] *Review with coding:* ~while~ loops
...
** TODO Review: ~while~ loops

1. The ~while~ loop allows you to print numbers 0 to 9.
...
4. Print the squares of all integers from i=1 to N.
...
5. What's the code to get a sequence of numbers from the keyboard if
   the end of the sequence is signalled by a =0= input?
