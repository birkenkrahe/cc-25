...
- Transforming C ~struct~ into C++ ~class~
- Understanding that data can be ~private~ or ~public~
- Accessing ~private~ data
- Member data and methods
- Creating a =Date= class for =today=
- Creating a =Player= class with =takeDamage= and =heal=
