...
- [ ] At the end of next week, you will know if you need to write the
  (optional) final exam to bump up your grade (by at most 25%).

- [ ] The last test (pointers) is available (full points if you
  complete by May 2nd).

- [ ] Now is the time to put in a little effort for bonus exercises,
  to offset missing points in tests or assignments!

- [ ] I published one last bonus assigmnent - changing the values of
  two variables using pointers.

- [ ] If you missed out on tests or assignments, you can still
