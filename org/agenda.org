...
* Week 10: Control ~switch~ & loops
#+attr_html: :width 400px :float nil:
#+caption: Medieval woodcut
[[../img/woodcut.jpg]]

- [ ] *Wednesday 19 March*: Last day to drop class with a *W* (Withdrawal)
- [ ] *Test 7* is live and due Friday, March 21 (220 questions so far!)
- [ ] *Programming assignment:* "Equip a weapon or shield"
- [ ] *Bonus assignment*: "Boss fight!"
- [ ] *Lecture/practice:* ~switch~ structures
- [ ] *Home assignment*: Telephone area codes with ~switch~

** TODO Popquiz

- Complete [[https://github.com/birkenkrahe/cc-25/blob/main/pdf/popquiz.pdf][this popquiz (PDF)]] in your own time.
- It should not take you more than 30 minutes complete.
...
** TODO The ~switch~ and ~break~ commands
