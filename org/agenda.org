...
- [ ] Practice: Printing formatted values in C
- [ ] Lecture: Variables & Types

** DONE Test 1 results and MIA
...
** DONE Review/Test preview: Introduction
...
** DONE Printing formatted values (in-class practice with upload)

#+attr_html: :width 700px: 
#+caption: Tokenized printf command
[[../img/whiteboard.png]]

** TODO Test 1 deadline is this Friday (11:59 pm)!

- First results look promising!
- Take your merry time with the test!
- When asked about code, try it out!

** TODO Assignment review: Hello world program with comments
...
3. What's wrong with this code?
   ...
   #+begin_quote
   The =main= functon must =return= an =int=, not =void=.
...
** TODO Lecture & code along: Variables & Assignments
