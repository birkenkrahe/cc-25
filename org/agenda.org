...
* IN-PROGRESS Week 7: Operators 

** DONE Wrong test 5 question
...
** DONE Review programming assignment
...
** DONE Review - arithmetic operators and shell compilation
...
** IN-PROGRESS *Lecture & Practice:* Operators (=++=, =*==, =&&=)

*Three types of operators:*
1) [X] arithmetic operators like ~*~
2) [ ] logical and relational operators like ~==~ and ~<~
...
** TODO NOT ~!~ question by Nichole (with a preview)
...
** TODO Next programming assignments
...
* Week 8: Operators II & Conditionals: =if= & =else= & =else if=
* Week 9: Loops:  =for= & =while= & =do=
* Week 10: Arrays
* Week 11: Functions
* Week 12: Pointers
