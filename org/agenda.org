...
* IN_PROGRESS Week 6: =scanf= practice & Operators
#+attr_html: :width 400px:
...
** DONE *Test 5*: =printf= and =scanf=. Deadline: 21 Feb (closes: 28 Feb)
...
** DONE Checked your programming assignments - who needs tutoring?
...
** DONE *Videos* on Google Cloud Shell ("Panopto" tab in Canvas):
...
** DONE *Practice*: Linux commands (=ls=, =cd=, =mkdir=, =rm=, =echo=, =history=
...
** DONE *Bonus assignment:* Download Google Cloud Shell to your PC.
...
** IN_PROGRESS *Practice:* =scanf= exercises in Google Cloud Shell
...
** TODO Review: The command-line shell / GCC compiler / ~nano~ editor
...
* Week 7: Operators & Pseudocode & =if= & =else= & =switch=

** TODO *Lecture:* Operators (=++=, =*==, =&&=)


** TODO *Practice:* Operators
...
*
* Week 8: Loops: =for= & =while= & =do=
* Week 9: Arrays
* Week 10: Functions
* Week 11: Program Organization
* Week 12: Pointers
